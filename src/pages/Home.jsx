...
const Home = () => {
  return (
    ...
    <motion.div className='py-24   h-screen relative  justify-center px-9  flex bg-color1 lg:px-16' initial ={{opacity: 0}} animate={{opacity:1}} exit={{opacity:0}}>
     ...
     A Frontend Developer Who loves to Design!
         </div>
